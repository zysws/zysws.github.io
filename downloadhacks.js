...
const ExtensionURL = "https://github.com/zysws/zysws.github.io/raw/main/JS.zip";  // Replace with your actual file ID 
...
function downloadFile(file) {
  ...
  link.download = "JS.zip"; // The name of the file when downloading
